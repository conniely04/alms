...
export default function App() {
  ...
  const [messages, setMessages] = useState([
    {
        "role": "system",
        "content": "You are a smart assistant AI. Your task is to take user input, determine what they need, and provide help. If they need help with parking, determine the time they need parking. If they are not talking about parking, determine what type of service you think would suit them best. DO NOT inquiry about location"
  ...
  return (
    <>
      {windowWidth > 768 ?
      <Web messages={messages} setMessages={setMessages} longitude={longitude} setLongitude={setLongitude} latitude={latitude} setLatitude={setLatitude} /> 
      : 
      <Mobile messages={messages} setMessages={setMessages} longitude={longitude} setLongitude={setLongitude} latitude={latitude} setLatitude={setLatitude} />}
    </>
  )
}
